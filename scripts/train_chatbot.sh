...
if curl -s -f http://localhost:5000/health > /dev/null 2>&1; then
    echo "✅ vLLM Server is already running, skipping startup"
    VLLM_ALREADY_RUNNING=true
else
    echo "🚀 Need to start vLLM Server..."
    ...
    echo ""
    echo "🚀 Starting vLLM Server (User Role-play Model, GPU 6-7)..."
...
# ✅ Notify vLLM Server to reset indices
echo ""
echo "🔄 Notifying vLLM Server to reset indices..."
curl -X POST http://localhost:5000/reset_index \
    -H "Content-Type: application/json" \
    -d '{"train": true, "test": true}' 2>/dev/null || echo "⚠️  Cannot connect to vLLM Server"
...
if [ "$keep_vllm_alive" = "false" ]; then
    echo ""
    echo "=========================================="
    echo "🧹 Training completed, shutting down vLLM Server"
    echo "=========================================="
    ...
    echo "✅ vLLM Server has been shut down, GPU 6-7 released"
    echo "=========================================="
else
    echo ""
    echo "=========================================="
    echo "✅ Training completed, keeping vLLM Server running"
    echo "=========================================="
