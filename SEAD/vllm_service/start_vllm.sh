...
conda activate /home/hadoop-keeta-ai/dolphinfs_ssd_hadoop-keeta-ai/wangyujie_keeta_ai/daiyuqin/envs/verl_wcz
...
echo "  tensor_parallel_size=1 (单卡, 无NCCL)"
echo ""
